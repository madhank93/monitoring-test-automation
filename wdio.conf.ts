export const config: WebdriverIO.Config = {
  ...
  // './test/specs/**.spec.ts',,, './test/specs/add.candidate.spec.ts'
  ...
  //
  maxInstances: process.env.SELENOID === "true" ? 1 : 3,
  ...
  //
  // Make sure you have the wdio adap`ter package for the specific framework installed
